            ...
            <ul class="navbar-nav">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu bg-info" aria-labelledby="navbarDropdownMenuLink">
                        ...
                        <li><a class="dropdown-item" href="https://api.corolive.nz/whitianga/archive/"
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu bg-info" aria-labelledby="navbarDropdownMenuLink">
                        ...
                        <li><a class="dropdown-item" href="https://api.corolive.nz/whangamata/archive/"
                                target="_blank">Archive</a></li>
                    </ul>
                </li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu bg-info" aria-labelledby="navbarDropdownMenuLink">
                        ...
                        <li><a class="dropdown-item" href="https://api.corolive.nz/thames/archive/"
                                target="_blank">Archive</a></li>
                    </ul>
                </li>
