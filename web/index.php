    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
                ...
                <div class="card text-center">
                    <div class="card-body">
                        <a href="whitianga"><img id="whitianga-thumbnail"
                                src="https://api.corolive.nz/imgproxy/S5fvR7DSxAnpNu1Os0xd37tAiFNTAR-l1bpoqPvPTRY/rs:fit::360:0/g:no/aHR0cHM6Ly9hcGkuY29yb2xpdmUubnovd2hpdGlhbmdhL3NuYXAud2VicA.webp?rand=<?php echo (rand());?>"
                                draggable="false" class="card-img-top" alt="Whitianga picker image"></a>
                ...
                <div class="card text-center">
                    <div class="card-body">
                        <a href="whangamata"><img id="whangamata-thumbnail"
                                src="https://api.corolive.nz/imgproxy/9nD2ByfvIPnevn470C9-JJ6lt62L7STOasLq6QMsFak/rs:fit::360:0/g:no/aHR0cHM6Ly9hcGkuY29yb2xpdmUubnovd2hhbmdhbWF0YS9zbmFwLndlYnA.webp?rand=<?php echo (rand());?>"
                                draggable="false" class="card-img-top" alt="Whangamata picker image"></a>
            ...
            <div class="col-sm-3">
                <div class="card text-center">
                    <div class="card-body">
                        <a href="thames"><img id="thames-thumbnail"
                                src="https://api.corolive.nz/imgproxy/e7DkeRUycsd3to1M7TU2yHxBWK-GvvAiMus8jWNBmDM/rs:fit::360:0/g:no/aHR0cHM6Ly9hcGkuY29yb2xpdmUubnovdGhhbWVzL3NuYXAud2VicA.webp?rand=<?php echo (rand());?>"
